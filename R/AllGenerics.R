...
# Basic object info/retrevial/assignment (except dendro)
setGeneric(name = "orderSamples",def = function(x) {standardGeneric("orderSamples")})
setGeneric(name = "orderSamples<-",def = function(object, value) {standardGeneric("orderSamples<-")})
setGeneric(name = "clusterLabels",def = function(x) {standardGeneric("clusterLabels")})
setGeneric(name = "clusterLabels<-",def = function(object, value) {standardGeneric("clusterLabels<-")})
...
setGeneric(name = "nClusterings", def = function(x) {standardGeneric("nClusterings")})
setGeneric(name = "nFeatures",def = function(x) {standardGeneric("nFeatures")})
setGeneric(name = "nSamples",def = function(x) {standardGeneric("nSamples")})
setGeneric(name = "transformation",def = function(x) {standardGeneric("transformation")})
setGeneric(name = "transformation<-",def = function(object, value) {standardGeneric("transformation<-")})
...
setGeneric(name = "clusterTypes",def = function(x) {standardGeneric("clusterTypes")})
setGeneric(name = "clusterTypes<-",def = function(object,value) {standardGeneric("clusterTypes<-")})
...
setGeneric(name = "removeClusterings", def = function(x,...) {standardGeneric("removeClusterings")})

# ClusterLegend/Colors
...
setGeneric(name = "convertClusterLegend",def = function(object,  ...) {standardGeneric("convertClusterLegend")})

# Basic Summaries/Operations
...
setGeneric(name = "transformData",def = function(object,...) {standardGeneric("transformData")})


## Dendrogram
setGeneric(name = "dendroClusterIndex",def = function(x) {standardGeneric("dendroClusterIndex")})
setGeneric(name = "makeDendrogram", def = function(x,  ...) {standardGeneric("makeDendrogram")})
...
setGeneric(name="plotHeatmap",def=function(data,...){standardGeneric("plotHeatmap")})

# Contrasts
setGeneric(name="plotContrastHeatmap",def=function(object,...){standardGeneric("plotContrastHeatmap")})
