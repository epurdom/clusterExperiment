...
#' @param dimReduce What dimensionality reduction method to use. Should match either a \code{reducedDimNames(x)} or one of the built-in functions of \code{\link{builtInDimReduce}()}
