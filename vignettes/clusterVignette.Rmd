...
```{r basicSubsampling2}
subsampleCluster2<-clusterAll(simData, subsample=TRUE, sequential=FALSE, clusterFunction="pam",clusterDArgs=list('k'=4),subsampleArgs=list("k"=2, clusterFunction="kmeans"))
