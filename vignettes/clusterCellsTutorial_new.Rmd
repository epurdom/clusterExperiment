...
The results from clusterExperiment will make an object `ClusterExperiment` that expands the `SummarizedExperiment` object, meaning the commands for accessing the data of a `SummarizedExperiment` will carry over to the `ClusterExperiment`.
...
The standard pipeline we propose consists of the following steps:
