...
ce<-clusterMany(se, clusterFunction="pam",ks=5:10, minSizes=5,
      isCount=TRUE,dimReduce=c("PCA","var"),nFilter=c(100,500,1000),
...
* For most variable reduction, choose 100, 500, and 1000 most variable genes (set `nFilter=c(100,500,1000)`)
...
nFilter       | dimReduce in 'mad','cv','var' | transform | nFilter
...
dSp<-spearDist(t(transformData(ce,dimReduce="mad",nFilter=1000)))
...
checkParam<-clusterMany(se, clusterFunction="pam", ks=2:10,
                        ...
                        dimReduce=c("PCA","var"),
                        nFilter=c(100,500,1000),nPCADims=c(5,15,50),run=FALSE)
...
ce<-clusterMany(ce, clusterFunction="pam",ks=2:10,findBestK=TRUE,removeSil=c(TRUE), isCount=TRUE,dimReduce=c("PCA","var"),nFilter=c(100,500,1000),nPCADims=c(5,15,50),run=TRUE)
```
