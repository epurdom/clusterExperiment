...
renameClusters(ce,whichClusters=1,value=newName)
print(ce)
```
...
renameClusters(ce_temp,whichClusters="mergeClusters",value=newNames)
recolorClusters(ce_temp,whichClusters="mergeClusters",value=newColors)
```
