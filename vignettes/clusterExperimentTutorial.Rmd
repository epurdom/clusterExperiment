...
knitr::opts_chunk$set(fig.align="center", cache=FALSE, cache.path = "clusterExperimentTutorial_cache/", optipng=' ', fig.path="clusterExperimentTutorial_figure/",error=FALSE, #make it stop on error
...
To vary the display, we'll show the display where we put blocks of color instead of names (`plotType="colorblock"`) and we also decide to show the leaves as the individual samples instead of the clusters (`leafType="sample"`); the combination of which gives us color blocks equal to the size of the clusterings. 
