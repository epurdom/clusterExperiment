...
Now we mark the "mergeClusters.2" version as the final one by changing it's clusterType manually to "final". 

```{r markFinal}
whFinal<-which(clusterType(ce)=="mergeClusters.2")
