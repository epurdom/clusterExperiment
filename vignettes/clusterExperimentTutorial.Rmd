...
Again, there is both a "ContrastName" and "Contrast" column. The "Contrast" column identifies which clusters were on each side of the node (and hence commpared) and "ContrastName" is a name for the node.
...
plotDendrogram(ce,show.node.label=TRUE,whichClusters=c("combineMany","mergeClusters"),leaf="samples",label="colorblock")
```
