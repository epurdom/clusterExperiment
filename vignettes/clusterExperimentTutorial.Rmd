...
ceSub<-clusterSingle(ce,dimReduce="mad",ndims=1000,subsample=TRUE,subsampleArgs=list(clusterArgs=list(k=8)),clusterLabel="subsamplingCluster",clusterDArgs=list(clusterFunction="hierarchical01",minSize=5))
