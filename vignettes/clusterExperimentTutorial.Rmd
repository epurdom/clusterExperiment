...
Note that if I call `getBuiltInFunction` for only one cluster, it returns the actual `ClusterFunction` object, not a list of length 1. To combine it with other functions you need to make it into a list.
