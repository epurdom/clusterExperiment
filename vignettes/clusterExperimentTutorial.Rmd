...
knitr::opts_chunk$set(fig.align="center", cache=TRUE, cache.path = "clusterExperimentTutorial_cache/", fig.path="clusterExperimentTutorial_figure/", fig.width=6,fig.height=6,error=FALSE,autodep=TRUE,out.width="600px",out.height="600px")
knitr::dep_auto()
