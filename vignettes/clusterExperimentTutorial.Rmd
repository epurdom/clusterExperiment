...
We will now run `RSEC` to find clusters of the cells. Because this procedure is computationally intensive, we have set this code to not run (changing `eval=TRUE` will run the code)

```{r RSEC, eval=FALSE}

```

Instead we will have save the results from this call. We will load it into the vignette:
